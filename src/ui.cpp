...
UI::UI(U8G2_ST7920_128X64_F_SW_SPI* display, System_State* system_state) {
  ...
  m_screens->insert(std::pair<Screen_Type, Screen*>(Screen_Type::CREATE_PROGRAM_SCREEN, new Create_Program_Screen(m_u8g2, m_system_state, m_screen_manager)));
  m_screens->insert(std::pair<Screen_Type, Screen*>(Screen_Type::RUN_PROGRAM_SCREEN, new Running_Program_Screen(m_u8g2, m_system_state, m_screen_manager)));
